...
#SBATCH --job-name=gptqs_l2_7b_4bit_rot_first
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
QUANT_DIR=/home/yunjun0914/GPTQ_Sinkhorn/outputs/l2_7b_4bit_rot_first
RECON_DIR=/home/yunjun0914/GPTQ_Sinkhorn/outputs/l2_7b_4bit_rot_first_recon
...
# GPTQ + rotation → gh (rotation_first)
...
4bit + rotation→gh (rotation_first)
wt2=$W2 c4=$C4"
