...
#SBATCH --job-name=gptqs_l3_8b_4bit_sinkhorn_had
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
QUANT_DIR=/home/yunjun0914/GPTQ_Sinkhorn/outputs/l3_8b_4bit_sinkhorn_had
RECON_DIR=/home/yunjun0914/GPTQ_Sinkhorn/outputs/l3_8b_4bit_sinkhorn_had_recon
...
LLaMA-3-8B 4bit gh→had (Sinkhorn + Hadamard)
wt2=$W2 c4=$C4"
