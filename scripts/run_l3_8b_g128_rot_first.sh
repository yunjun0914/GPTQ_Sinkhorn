...
#SBATCH --job-name=gptqs_l3_8b_g128_rot_first
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
QUANT_DIR=/home/yunjun0914/GPTQ_Sinkhorn/outputs/l3_8b_g128_rot_first
RECON_DIR=/home/yunjun0914/GPTQ_Sinkhorn/outputs/l3_8b_g128_rot_first_recon
