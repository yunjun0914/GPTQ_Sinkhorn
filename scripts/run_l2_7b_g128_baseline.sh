...
#SBATCH --job-name=gptqs_l2_7b_g128_baseline
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
QUANT_DIR=/home/yunjun0914/GPTQ_Sinkhorn/outputs/l2_7b_g128_baseline
RECON_DIR=/home/yunjun0914/GPTQ_Sinkhorn/outputs/l2_7b_g128_baseline_recon
