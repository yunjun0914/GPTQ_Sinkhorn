...
#SBATCH --job-name=gptqs_l2_7b_4bit_sinkhorn
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
QUANT_DIR=/home/yunjun0914/GPTQ_Sinkhorn/outputs/l2_7b_4bit_sinkhorn
RECON_DIR=/home/yunjun0914/GPTQ_Sinkhorn/outputs/l2_7b_4bit_sinkhorn_recon
...
# GPTQ + Sinkhorn normalization, no Hadamard
