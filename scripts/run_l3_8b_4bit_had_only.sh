...
#SBATCH --job-name=gptqs_l3_8b_4bit_had_only
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
QUANT_DIR=/home/yunjun0914/GPTQ_Sinkhorn/outputs/l3_8b_4bit_had_only
RECON_DIR=/home/yunjun0914/GPTQ_Sinkhorn/outputs/l3_8b_4bit_had_only_recon
...
LLaMA-3-8B 4bit Hadamard only (no sinkhorn)
wt2=$W2 c4=$C4"
