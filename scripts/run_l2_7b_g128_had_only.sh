...
#SBATCH --job-name=gptqs_l2_7b_g128_had_only
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
QUANT_DIR=/home/yunjun0914/GPTQ_Sinkhorn/outputs/l2_7b_g128_had_only
RECON_DIR=/home/yunjun0914/GPTQ_Sinkhorn/outputs/l2_7b_g128_had_only_recon
...
LLaMA-2-7B 4bit g128 Hadamard only
wt2=$W2 c4=$C4"
