...
#SBATCH --job-name=gptqs_l2_7b_4bit_baseline
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
QUANT_DIR=/home/yunjun0914/GPTQ_Sinkhorn/outputs/l2_7b_4bit_baseline
RECON_DIR=/home/yunjun0914/GPTQ_Sinkhorn/outputs/l2_7b_4bit_baseline_recon
...
# Plain GPTQ, no Sinkhorn, no Hadamard (ablation baseline)
...
send_ch yunjun0914_exp "[DONE] rabbit $SLURM_JOB_NAME ($SLURM_JOB_ID)
4bit baseline (no sinkhorn, no had)
wt2=$W2 c4=$C4"
